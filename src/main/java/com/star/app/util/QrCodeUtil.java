...
//                            pixels[y * size + x] = 0xffffffff;
    ...
    public static Bitmap createQRImage(Context context, String data, Bitmap logoBm) {
        try {
            ...
            if (logoBm != null) {
                bitmap = addLogo(null, bitmap, logoBm);
            }
     ...
     * 在二维码中间添加Logo图案
     */
    public static Bitmap addLogo(Context context, Bitmap src, Bitmap logo) {
        if (src == null) {
            return null;
        }
        if (logo == null) {
        ...
        try {
            ...
            //设置logo 的背景
            Bitmap bitmapLogo = Bitmap.createBitmap(logoWidth + 2, logoHeight + 2, Bitmap.Config.RGB_565);
            Canvas canvasLogo = new Canvas(bitmapLogo);
            canvasLogo.drawColor(context.getResources().getColor(R.color.cffffff));
            canvasLogo.drawBitmap(logo, 1, 1, null);
            //设置logo
